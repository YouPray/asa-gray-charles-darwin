...
;(function (jQuery, document, window) {
	...
	Plugin.prototype.init = function () {
		...
		var menuBar = jQuery('<div class="'+prefix+'_menu visible-xs"></div>');
		//TT:jQuerythis.btn = jQuery('<'+settings.parentTag+' aria-haspopup="true" tabindex="0" class="'+prefix+'_btn '+prefix+'_collapsed"><span class="'+prefix+'_menutxt">'+settings.label+'</span><span class="'+iconClass+'"><span class="'+prefix+'_icon-bar"></span><span class="'+prefix+'_icon-bar"></span><span class="'+prefix+'_icon-bar"></span></span></a>');
		jQuerythis.btn = jQuery('<'+settings.parentTag+' aria-haspopup="true" tabindex="0" class="'+prefix+'_btn '+prefix+'_collapsed steadylink"><span class="'+prefix+'_menutxt">'+settings.label+'</span><div class="fa-bars" style="font-size:22px;"></div></span></a>');
